...
UCLASS()
class GP4_LYMBO_API UPlayerRunningState : public UPlayerStateBase
{
	GENERATED_BODY()

public:
	UPlayerRunningState(const FObjectInitializer& ObjectInitializer) : UPlayerStateBase(ObjectInitializer){}
